...
import { UserProject } from 'src/infrastructure/database';
import type { UserProjectModel } from 'src/domain/models';
...
export class UserProjectRepository extends BaseRepository<UserProject, UserProjectModel> {
  ...
  public toModel(entity: UserProject): UserProjectModel {
