...
import type { AuthCode } from 'src/database/authcode.entity';
import type { City } from 'src/database/city.entity';
import type { Country } from 'src/database/country.entity';
import type { ConsultingArchitecture } from 'src/database/projects/consulting-architecture.entity';
import type { DataUserProfile } from 'src/database/data-user-profile.entity';
import type { Development } from 'src/database/projects/development.entity';
import type { DynamicField } from 'src/database/dynamic-field.entity';
import type { EmailTemplate } from 'src/database/email-template.entity';
import type { EnergyAsset } from 'src/database/projects/energy-asset.entity';
import type { Financing } from 'src/database/projects/financing.entity';
import type { Infrastructure } from 'src/database/projects/infrastructure.entity';
import type { NaturalResourcesDevelopment } from 'src/database/projects/natural-resources-development.entity';
import type { NaturalResourcesFinancing } from 'src/database/projects/natural-resources-financing.entity';
import type { ProjectFile } from 'src/database/project-file.entity';
import type { Project } from 'src/database/projects/project.entity';
import type { RealState } from 'src/database/projects/real-state.entity';
import type { Region } from 'src/database/region.entity';
import type { Role } from 'src/database/role.entity';
import type { State } from 'src/database/state.entity';
import type { SubRegion } from 'src/database/subregion.entity';
import type { TrustedDevice } from 'src/database/trusted-device.entity';
import type { UserDynamicField } from 'src/database/user-dynamic-field.entity';
import type { UserProject } from 'src/database/user-project.entity';
import type { User } from 'src/database/user.entity';
import type { VerifiedPhone } from 'src/database/verified-phone.entity';
import type { Education } from 'src/database/education.entity';
import type { ProfessionalExperience } from 'src/database/professional-experience.entity';
import type { Notification } from 'src/database/notification.entity';
